...
public class Student implements Serializable {
    ...
    public Student(Cursor cursor) {
        mId = cursor.getInt(cursor.getColumnIndex(HSDataContract.StudentEntry.COLUMN_NAME_ID));
        mName = cursor.getString(cursor.getColumnIndex(HSDataContract.StudentEntry.COLUMN_NAME_FULL_NAME));
        mImageUrl = cursor.getString(cursor.getColumnIndex(HSDataContract.StudentEntry.COLUMN_NAME_IMAGE_URL));
        mJob = cursor.getString(cursor.getColumnIndex(HSDataContract.StudentEntry.COLUMN_NAME_JOB));
        mJobUrl = cursor.getString(cursor.getColumnIndex(HSDataContract.StudentEntry.COLUMN_NAME_JOB_URL));
        mSkills = cursor.getString(cursor.getColumnIndex(HSDataContract.StudentEntry.COLUMN_NAME_SKILLS));
        mEmail = cursor.getString(cursor.getColumnIndex(HSDataContract.StudentEntry.COLUMN_NAME_EMAIL));
        mGithubUrl = cursor.getString(cursor.getColumnIndex(HSDataContract.StudentEntry.COLUMN_NAME_GITHUB));
        mTwitterUrl = cursor.getString(cursor.getColumnIndex(HSDataContract.StudentEntry.COLUMN_NAME_TWITTER));
        mBatch = cursor.getString(cursor.getColumnIndex(HSDataContract.StudentEntry.COLUMN_NAME_BATCH));
        mBatchId = cursor.getString(cursor.getColumnIndex(HSDataContract.StudentEntry.COLUMN_NAME_BATCH_ID));
    }
